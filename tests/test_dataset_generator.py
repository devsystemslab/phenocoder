import os
import shutil
from phenocoder.generator import DatasetGenerator, DatasetMerger
...
def test_dataset_generator_and_merging(delete_test_dir=True):
    ...
    for plate in plates:
        dataset_generator = DatasetGenerator(
            dir_input=f'{dir_screen}/{plate}/{plate}-01/TIF_OVR_BG',
        ...
        dataset_generator.generate_dataset(
            sampling_frac=None,
            per_channel=True,
            qc_path='/pstore/data/ihb-g-deco/USERS/schulzp9/tumoroid/qc_test.csv',
        )  # , n_patches=500)
